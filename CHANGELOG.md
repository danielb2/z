...
- [feature] Added `--increase` and `--decrease` to adjust the current directory's ranking score.
- [fix] List output keeps its original score-and-path format while manual adjustments use exact score deltas.
